"""
Positions (bin locations) API router.
Adds position-aware pick/put-away and transfers.
"""
...
from ..dependencies import get_position_service, get_stock_movement_service
