...
from app.integrations.ai.settings import ai_engine_settings
...
try:
    from app.shared.core.advanced_validation import SQLInjectionValidator
...
from app.integrations.ai.sql_parser import SQLParserValidator
