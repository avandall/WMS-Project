...
from app.exceptions.business_exceptions import DocumentNotFoundError, InvalidDocumentStatusError
...
class DocumentService:
    def __init__(self, repo: IDocumentRepo, warehouse_service: WarehouseService):
        self.repo = repo
