...
from ..module.custom_exceptions import ReportGenerationError, InvalidReportParametersError
...
from ..report.inventory_report import WarehouseInventoryReport, TotalInventoryReport, InventoryReportItem
from ..report.document_report import DocumentReport, DocumentReportItem
from ..report.product_report import ProductMovementReport, ProductMovementItem
from ..report.warehouse_report import WarehousePerformanceReport, WarehousePerformanceItem
from ..domain.product_domain import Product

class ReportService:
    """Service for generating various reports."""

    def __init__(self, product_repo: ProductRepo, document_repo: DocumentRepo,
                 warehouse_repo: WarehouseRepo, inventory_repo: InventoryRepo):
