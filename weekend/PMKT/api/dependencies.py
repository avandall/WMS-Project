...
def get_product_repo() -> ProductRepo:
...
def get_warehouse_repo() -> WarehouseRepo:
    """Get warehouse repository instance."""
    global _warehouse_repo
    if _warehouse_repo is None:
        _warehouse_repo = WarehouseRepo(get_inventory_repo())
...
def get_product_service() -> ProductService:
    ...
    if _product_service is None:
        _product_service = ProductService(get_product_repo())
...
def get_inventory_service() -> InventoryService:
    ...
    if _inventory_service is None:
        _inventory_service = InventoryService(get_inventory_repo())
...
def get_warehouse_service() -> WarehouseService:
    ...
    if _warehouse_service is None:
        _warehouse_service = WarehouseService(get_warehouse_repo())
...
def get_document_service() -> DocumentService:
    ...
    if _document_service is None:
        _document_service = DocumentService(get_document_repo(), get_warehouse_service())
